	...
	<h3 class="heading text-center mb-3 mb-sm-5">About More</h3>
            <div class="row mid-grids mt-lg-5 mt-3">
                <div class="col-md-5 content-w3pvt-img">
                    <img src="{{asset('assets/frontend/images/ab1.jpg')}}" alt="" class="img-fluid">
                </div>
            ...
            <div class="row mid-grids mt-lg-5 mt-3 py-3">
                ...
                <div class="col-md-5 content-w3pvt-img mt-lg-0 mt-3">
                    <img src="{{asset('assets/frontend/images/ab2.jpg')}}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row mt-lg-5 mt-4">
                <div class="col-md-4 team-gd text-center">
                    <div class="team-img mb-4">
                        <img src="{{asset('assets/frontend/images/t1.jpg')}}" class="img-fluid" alt="user-image">
                    </div>
                    <div class="team-info">
                ...
                <div class="col-md-4 team-gd second text-center my-md-0 my-5">
                    <div class="team-img mb-4">
                        <img src="{{asset('assets/frontend/images/t2.jpg')}}" class="img-fluid" alt="user-image">
                    </div>
                    <div class="team-info">
                ...
                <div class="col-md-4 team-gd text-center">
                    <div class="team-img mb-4">
                        <img src="{{asset('assets/frontend/images/t3.jpg')}}" class="img-fluid" alt="user-image">
                    </div>
                    <div class="team-info">
