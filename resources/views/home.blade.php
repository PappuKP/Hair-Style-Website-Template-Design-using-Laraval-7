		...
		<h3 class="heading text-center mb-3 mb-sm-5">About us</h3>
            ...
            <div class="info-w3pvt-mid text-center px-lg-5">
                ...
                <div class="title-desc text-center px-lg-5">
					<img src="{{asset('assets/frontend/images/about1.png')}}" alt="news image" class="img-fluid">
		...
		<h3 class="heading text-center mb-3 mb-sm-5">Services</h3>
            <div class="row ab-info">
                <div class="col-md-6 ab-content ab-content1">
                    <div class="ab-content-inner">
                        <a href="single.html"><img src="{{asset('assets/frontend/images/services2.jpg')}}" alt="news image" class="img-fluid"></a>
                ...
                <div class="col-md-6 ab-content ab-content1">
                    <div class="ab-content-inner">
                        <a href="single.html"><img src="{{asset('assets/frontend/images/services1.jpg')}}" alt="news image" class="img-fluid"></a>
                        <div class="ab-info-con">
            ...
            <div class="row ab-info second mt-lg-4">
                <div class="col-md-3 ab-content">
                    <div class="ab-content-inner">
                        <a href="single.html"><img src="{{asset('assets/frontend/images/ser3.jpg')}}" alt="news image" class="img-fluid"></a>
                        <div class="ab-info-con">
                            <h4>colouring</h4>
                            <a href="single.html" class="read-more two btn m-0 px-3"><span class="fa fa-arrow-circle-o-right"> </span></a>
                        </div>
                ...
                <div class="col-md-3 ab-content">
                    <div class="ab-content-inner">
                        <a href="single.html"><img src="{{asset('assets/frontend/images/ser4.jpg')}}" alt="news image" class="img-fluid"></a>
                        <div class="ab-info-con">
                            <h4>Bathing</h4>
                            <a href="single.html" class="read-more two btn m-0 px-3"><span class="fa fa-arrow-circle-o-right"> </span></a>
                        </div>
                ...
                <div class="col-md-3 ab-content">
                    <div class="ab-content-inner">
                        <a href="single.html"><img src="{{asset('assets/frontend/images/ser5.jpg')}}" alt="news image" class="img-fluid"></a>
                        <div class="ab-info-con">
                            <h4>drying</h4>
                            <a href="single.html" class="read-more two btn m-0 px-3"><span class="fa fa-arrow-circle-o-right"> </span></a>
                        </div>
                ...
                <div class="col-md-3 ab-content">
                    <div class="ab-content-inner">
                        <a href="single.html"><img src="{{asset('assets/frontend/images/ser6.jpg')}}" alt="news image" class="img-fluid"></a>
                        <div class="ab-info-con">
                            <h4>Creams</h4>
                            <a href="single.html" class="read-more two btn m-0 px-3"><span class="fa fa-arrow-circle-o-right"> </span></a>
                        </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4 test-grid text-left px-lg-3">
                    <div class="test-info">
                        ...
                        <div class="test-img text-center mb-3">
                            <img src="{{asset('assets/frontend/images/test1.jpg')}}" class="img-fluid" alt="user-image">
                        </div>
                ...
                <div class="col-md-4 test-grid text-left px-lg-3 py-sm-5 py-md-0 py-3">
                    <div class="test-info">
                        ...
                        <div class="test-img text-center mb-3">
                            <img src="{{asset('assets/frontend/images/test2.jpg')}}" class="img-fluid" alt="user-image">
                        </div>
                        <div class="mobl-footer test-soc text-center">
                            <ul class="list-unstyled">
                                <li>
                ...
                <div class="col-md-4 test-grid text-left px-lg-3">
                    <div class="test-info">
                        ...
                        <div class="test-img text-center mb-3">
                            <img src="{{asset('assets/frontend/images/test3.jpg')}}" class="img-fluid" alt="user-image">
                        </div>
                        <div class="mobl-footer test-soc text-center">
                            <ul class="list-unstyled">
                                <li>
