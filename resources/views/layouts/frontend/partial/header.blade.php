				...
				<nav>
					...
					<input type="checkbox" id="drop" />
						<ul class="menu">
							...
							<li class="mr-lg-3 mr-2"><a href="{{url('/about')}}">About </a></li>
							...
							<li class="mr-lg-3 mr-2"><a href="{{url('/gallery')}}">Gallery</a></li>
							<li class="mr-lg-3 mr-2"><a href="{{url('/contact')}}">Contact Us</a></li>
